...
- **Optional profile data:** may include optional profile fields such as DOB if provided.
...
We use service providers that act as processors to operate the App, including infrastructure and authentication providers (for example, managed database hosting and identity/authentication services).
